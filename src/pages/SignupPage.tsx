...
import OtherLogo from '../assets/Lekalakala Dental Logo.png';
                ...
                <Form noValidate validated={validated} onSubmit={handleSignup}>
                    ...
                    <Form.Group controlId="formBasicIsDoctor">
                        <Form.Check
                            ...
                            style={{display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '12px', color: 'white'}}
                        />
                    </Form.Group>
